...
if main_page == "Main page":
  ...
  st.write("""Commissioned by EUROCONTROL and as part of the minor Data Science at the Amsterdam University of Applied Sciences (AUAS), research was conducted on the sustainability of aviation on the AMS-network. The AMS-network consists of all flight routes from Amsterdam Airport Schiphol to European destinations to which at least two different airlines fly. A total of 54 European destinations and 33 airlines were investigated. With this information, three tools are created, each useful for a different target group. To guide you through this dashboard, the different tools are explained below."\n
           *The different tools can be accessed via the sidebar "Which user are you?".*\n
           If you are a **passenger**...\n
           Sustainability is becoming increasingly important, especially in aviation. Are you someone who likes to fly but wants to pay attention to your ecological footprint, then use our tool! With this tool you can check which airline is the most sustainable per European destination and even which day of the week is the most sustainable. In addition, it is possible to see the amount of CO2 emitted per seat for a particular flight. You can even see how many trees you would have to plant to compensate your CO2 emissions of the trip.""")
