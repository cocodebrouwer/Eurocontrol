...
if nav == "Passengers": 
  ...
  loadfactor1 = col1.slider(label='Loadfactor 1', min_value=0, max_value=1, step=float)
  loadfactor2 = col2.slider(label='Loadfactor 2', min_value=0, max_value=1, step=float)
