...
if nav == "Passengers": 
  ...
  Alledagen = ['All days']
  Weekdagen = np.append(Weekdagen, Alledagen, axis=1)
  ...
  Airlines_compact = Data.drop_duplicates(subset=['Airline', 'Keurmerk']).sort_values('Mean CO2 per flight per airline (kg)')
