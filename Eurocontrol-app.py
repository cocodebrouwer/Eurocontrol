...
if main_page == "Main page":
  ...
  st.write("""Sustainability is becoming increasingly important, especially in aviation. Are you someone who likes to fly but wants to pay attention to your ecological footprint, then use our tool! With this tool you can check (per day of the week) which airline offers the most sustainable flight to your chosen European destination. Thereby it is possible to see per flight how much CO2 is emitted per seat in kilograms. And if you really want to contribute, you can plant the number of trees that is indicated for your flight (this way you compensate your CO2 emissions).""")
